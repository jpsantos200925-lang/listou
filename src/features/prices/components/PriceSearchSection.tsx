...
export default function PriceSearchSection({ itemId, itemName }: PriceSearchSectionProps) {
  ...
  return (
    <div className="px-3.5 pt-2.5 pb-3 bg-primary-5-item border border-primary-12 border-t-0 rounded-b-lg">
      ...
      {error && (
        <p className="text-[11px] text-red-400 mt-1 mb-1 px-0.5">Falha na busca: {error}</p>
      )}
