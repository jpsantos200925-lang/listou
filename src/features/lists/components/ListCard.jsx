    ...
    >
      <div className="w-11 h-11 rounded-[10px] overflow-hidden shrink-0">
        {list.logo_url ? (
          ...
          <div className={`${styles.logoPlaceholder} w-full h-full flex items-center justify-center font-bold text-[1.1rem] rounded-[10px]`}>
      ...
      <div className="flex-1 flex flex-col gap-[0.2rem]">
        ...
        <span className={`${styles.slug} text-[0.68rem] font-mono tracking-[0.01em]`}>/{list.slug}</span>
      </div>
      ...
      <svg className={`${styles.chevron} shrink-0`} width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
